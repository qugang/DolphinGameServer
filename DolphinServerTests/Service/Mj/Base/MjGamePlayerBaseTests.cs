    ...
    public class MjGamePlayerBaseTests
    {
        ...
        public void CheckHuTest()
        {
            ...
            player.InitCard(new int[] {
                   //初始化万,0x10 表示1张
                2|0x10,3|0x10,4|0x10,6|0x10,7|0x10,8|0x10,
                //初始化筒,0x10表示1张,0x80表示筒
                4|0x10|0x80,4|0x10|0x80,5|0x10|0x80,6|0x10|0x80,7|0x10|0x80,
                //初始化条,0x10表示1张,0x100表示条
                2|0x10|0x100,3|0x10|0x100

            });
            Boolean result = player.CheckHu(4 | 0x10 | 0x100);
